            ...
            <div class="col-xs-12 col-sm-9 col-md-10">
                ...
                <div class="row" id="section-graphics">
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
                        <a class=" zoombox zgallery1 column" href="img/Graphisme/Originals/1a.png">
                        ...
                        <a class=" zoombox zgallery1" href="img/Graphisme/Originals/1b.png"></a>
                        <a class=" zoombox zgallery1" href="img/Graphisme/Originals/1c.png"></a>
                        <a class=" zoombox zgallery1" href="img/Graphisme/Originals/1d.png"></a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
                        <a class=" zoombox zgallery2 column" href="img/Graphisme/Originals/2a.png">
                            <img src="img/Graphisme/2.jpg" alt="" />
                            <div class="portfolio-hover-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam consequatur quia doloremque veritatis quis incidunt ex, unde enim rem quam officia vero harum, aut veniam ipsam cupiditate voluptates similique adipisci!</p>
                            </div>
                        </a>
                        <a class=" zoombox zgallery2" href="img/Graphisme/Originals/2b.png"></a>
                        <a class=" zoombox zgallery2" href="img/Graphisme/Originals/2c.png"></a>
                        <a class=" zoombox zgallery2" href="img/Graphisme/Originals/2d.png"></a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
                        <a class=" zoombox zgallery3 column" href="img/Graphisme/Originals/3a.png">
                            <img src="img/Graphisme/3.jpg" alt="" />
                            <div class="portfolio-hover-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam consequatur quia doloremque veritatis quis incidunt ex, unde enim rem quam officia vero harum, aut veniam ipsam cupiditate voluptates similique adipisci!</p>
                            </div>
                        </a>
                        <a class=" zoombox zgallery3" href="img/Graphisme/Originals/3b.png"></a>
                        <a class=" zoombox zgallery3" href="img/Graphisme/Originals/3c.png"></a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
                        <a class=" zoombox zgallery6 column" href="img/Graphisme/Originals/6a.png">
                            <img src="img/Graphisme/6.jpg" alt="" />
                            <div class="portfolio-hover-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam consequatur quia doloremque veritatis quis incidunt ex, unde enim rem quam officia vero harum, aut veniam ipsam cupiditate voluptates similique adipisci!</p>
                            </div>
                        </a>
                        <a class=" zoombox zgallery6" href="img/Graphisme/Originals/6b.png"></a>
                        <a class=" zoombox zgallery6" href="img/Graphisme/Originals/6c.png"></a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
                        ...
                        <a class=" zoombox zgallery7" href="img/Graphisme/Originals/7c.png"></a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 offset-0">
